...
import com.example.prabaths.inner.fragments.statistics.Comparison_Fragment1;
import com.example.prabaths.TravelBuddy.R;
import com.example.prabaths.inner.fragments.statistics.Patterns_Fragment1;
 ...
 */
public class Statistics_Fragment extends Fragment implements ViewPager.OnPageChangeListener,TabHost.OnTabChangeListener{
    ...
    private void initTabHost() {
        ...
        tabHost.setup();
        String[] tabNames={"Details","Patterns"};
    ...
    private void initViewPager() {
        ...
        list.add(new Comparison_Fragment1());
        list.add(new Patterns_Fragment1());
