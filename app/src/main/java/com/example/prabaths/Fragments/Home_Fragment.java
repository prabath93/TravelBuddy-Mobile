 ...
 */
public class Home_Fragment extends Fragment implements ViewPager.OnPageChangeListener,TabHost.OnTabChangeListener{
    ...
    private void initViewPager() {
        ...
        list.add(view_vehicle_for_home_fragment);
